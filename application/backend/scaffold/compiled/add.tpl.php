...
<?php $_from = $this->_var['entry']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('field', 'format_0_22928800_1453275574');if (count($_from)):
    foreach ($_from AS $this->_var['field'] => $this->_var['format_0_22928800_1453275574']):
?>
<?php if ($this->_var['format_0_22928800_1453275574'] == 'catalog'): ?>
...
<?php elseif ($this->_var['format_0_22928800_1453275574'] == 'select-from-db'): ?>
          <div class="item"><label class="item-title<?php if ($this->_var['null'] [ $this->_var['field'] ] == 'NO'): ?> mark<?php endif; ?>" for="<?php echo $this->_var['field']; ?>"><?php echo empty($this->_var['comments'][$this->_var['field']]) ? $this->_var['field'] : $this->_var['comments'][$this->_var['field']]; ?>：</label>
...
<?php elseif ($this->_var['format_0_22928800_1453275574'] == 'select-from-array'): ?>
          <div class="item"><label class="item-title<?php if ($this->_var['null'] [ $this->_var['field'] ] == 'NO'): ?> mark<?php endif; ?>" for="<?php echo $this->_var['field']; ?>"><?php echo empty($this->_var['comments'][$this->_var['field']]) ? $this->_var['field'] : $this->_var['comments'][$this->_var['field']]; ?>：</label>
            <select name="<?php echo $this->_var['field']; ?>" id="<?php echo $this->_var['field']; ?>">
              <option value=""><?php echo empty($this->_var['comments'][$this->_var['field']]) ? $this->_var['field'] : $this->_var['comments'][$this->_var['field']]; ?></option>
<?php echo '<?php'; ?>
...
<?php elseif ($this->_var['format_0_22928800_1453275574'] == 'radio-from-db'): ?>
          <div class="item"><label class="item-title<?php if ($this->_var['null'] [ $this->_var['field'] ] == 'NO'): ?> mark<?php endif; ?>" for="<?php echo $this->_var['field']; ?>"><?php echo empty($this->_var['comments'][$this->_var['field']]) ? $this->_var['field'] : $this->_var['comments'][$this->_var['field']]; ?>：</label>
<?php echo '<?php'; ?>
 foreach($<?php echo substr($this->_var['field'], 0, strrpos($this->_var['field'], "_id")); ?> as $k => $v):<?php echo '?>'; ?>
...
<?php elseif ($this->_var['format_0_22928800_1453275574'] == 'radio-from-array'): ?>
          <div class="item"><label class="item-title<?php if ($this->_var['null'] [ $this->_var['field'] ] == 'NO'): ?> mark<?php endif; ?>" for="<?php echo $this->_var['field']; ?>"><?php echo empty($this->_var['comments'][$this->_var['field']]) ? $this->_var['field'] : $this->_var['comments'][$this->_var['field']]; ?>：</label>
<?php echo '<?php'; ?>
 foreach($<?php echo $this->_var['field']; ?> as $k => $v):<?php echo '?>'; ?>
...
<?php elseif ($this->_var['format_0_22928800_1453275574'] == 'checkbox-from-db'): ?>
          <div class="item"><label class="item-title<?php if ($this->_var['null'] [ $this->_var['field'] ] == 'NO'): ?> mark<?php endif; ?>" for="<?php echo $this->_var['field']; ?>"><?php echo empty($this->_var['comments'][$this->_var['field']]) ? $this->_var['field'] : $this->_var['comments'][$this->_var['field']]; ?>：</label>
<?php echo '<?php'; ?>
 foreach($<?php echo substr($this->_var['field'], 0, strrpos($this->_var['field'], "_id")); ?> as $k => $v):<?php echo '?>'; ?>
...
<?php elseif ($this->_var['format_0_22928800_1453275574'] == 'checkbox-from-array'): ?>
          <div class="item"><label class="item-title<?php if ($this->_var['null'] [ $this->_var['field'] ] == 'NO'): ?> mark<?php endif; ?>" for="<?php echo $this->_var['field']; ?>"><?php echo empty($this->_var['comments'][$this->_var['field']]) ? $this->_var['field'] : $this->_var['comments'][$this->_var['field']]; ?>：</label>
<?php echo '<?php'; ?>
 foreach($<?php echo $this->_var['field']; ?> as $k => $v):<?php echo '?>'; ?>
...
<?php elseif ($this->_var['format_0_22928800_1453275574'] == 'switch'): ?>
...
<?php elseif ($this->_var['format_0_22928800_1453275574'] == 'enabled'): ?>
          <div class="item"><label class="item-title<?php if ($this->_var['null'] [ $this->_var['field'] ] == 'NO'): ?> mark<?php endif; ?>" for="<?php echo $this->_var['field']; ?>"><?php echo empty($this->_var['comments'][$this->_var['field']]) ? $this->_var['field'] : $this->_var['comments'][$this->_var['field']]; ?>：</label><input type="checkbox" name="<?php echo $this->_var['field']; ?>" id="<?php echo $this->_var['field']; ?>" value="1" /></div>
<?php elseif ($this->_var['format_0_22928800_1453275574'] == 'textarea'): ?>
...
<?php elseif ($this->_var['format_0_22928800_1453275574'] == 'editor'): ?>
...
<?php elseif ($this->_var['format_0_22928800_1453275574'] == 'attach'): ?>
...
<?php elseif ($this->_var['format_0_22928800_1453275574'] == 'image'): ?>
          <div class="item"><label class="item-title<?php if ($this->_var['null'] [ $this->_var['field'] ] == 'NO'): ?> mark<?php endif; ?>" for="<?php echo $this->_var['field']; ?>"><?php echo empty($this->_var['comments'][$this->_var['field']]) ? $this->_var['field'] : $this->_var['comments'][$this->_var['field']]; ?>：</label>
            <div class="item-area">
...
<?php elseif ($this->_var['format_0_22928800_1453275574'] == 'text'): ?>
          <div class="item"><label class="item-title<?php if ($this->_var['null'] [ $this->_var['field'] ] == 'NO'): ?> mark<?php endif; ?>" for="<?php echo $this->_var['field']; ?>"><?php echo empty($this->_var['comments'][$this->_var['field']]) ? $this->_var['field'] : $this->_var['comments'][$this->_var['field']]; ?>：</label><input type="text" class="input-txt long" name="<?php echo $this->_var['field']; ?>" id="<?php echo $this->_var['field']; ?>" /></div>
<?php elseif ($this->_var['format_0_22928800_1453275574'] == 'password'): ?>
...
<?php elseif ($this->_var['format_0_22928800_1453275574'] == 'date'): ?>
...
<?php elseif ($this->_var['format_0_22928800_1453275574'] == 'position'): ?>
...
<?php $_from = $this->_var['hidden']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('field', 'format_0_23034400_1453275574');if (count($_from)):
    foreach ($_from AS $this->_var['field'] => $this->_var['format_0_23034400_1453275574']):
?>
            <input type="hidden" name="<?php echo $this->_var['field']; ?>" id="<?php echo $this->_var['field']; ?>" value="" />
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
<?php endif; ?>
...
<?php $_from = $this->_var['catalog']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('field', 'format_0_23038700_1453275574');if (count($_from)):
    foreach ($_from AS $this->_var['field'] => $this->_var['format_0_23038700_1453275574']):
?>
...
<?php $_from = $this->_var['upload']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('field', 'format_0_23042900_1453275574');if (count($_from)):
    foreach ($_from AS $this->_var['field'] => $this->_var['format_0_23042900_1453275574']):
?>
<?php if ($this->_var['format_0_23042900_1453275574'] == 'image'): ?>
...
<?php endif; ?>
<?php if ($this->_var['editor']): ?>
<?php $_from = $this->_var['editor']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('field', 'format_0_23049300_1453275574');if (count($_from)):
    foreach ($_from AS $this->_var['field'] => $this->_var['format_0_23049300_1453275574']):
?>
...
<?php endif; ?>
<?php if ($this->_var['date']): ?>
<?php $_from = $this->_var['date']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('field', 'format_0_23052800_1453275574');if (count($_from)):
    foreach ($_from AS $this->_var['field'] => $this->_var['format_0_23052800_1453275574']):
?>
...
<?php if ($this->_var['position']): ?>
    $.region({
<?php $_from = $this->_var['position']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('field', 'format_0_23056100_1453275574');if (count($_from)):
    foreach ($_from AS $this->_var['field'] => $this->_var['format_0_23056100_1453275574']):
?>
<?php if ($this->_var['format_0_23056100_1453275574'] == 'position-province'): ?>
      province:$("#<?php echo $this->_var['field']; ?>")<?php elseif ($this->_var['format_0_23056100_1453275574'] == 'position-city'): ?>,
      city:$("#<?php echo $this->_var['field']; ?>")<?php elseif ($this->_var['format_0_23056100_1453275574'] == 'position-district'): ?>,
...
<?php if ($this->_var['editor']): ?>
<?php $_from = $this->_var['editor']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('field', 'format_0_23063900_1453275574');if (count($_from)):
    foreach ($_from AS $this->_var['field'] => $this->_var['format_0_23063900_1453275574']):
?>
...
<?php endif; ?>
    ...
    $("#myform").validate({
        rules: {
<?php $_from = $this->_var['verify']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('field', 'format_0_23066500_1453275574');$this->_foreach['seek'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['seek']['total'] > 0):
    foreach ($_from AS $this->_var['field'] => $this->_var['format_0_23066500_1453275574']):
        $this->_foreach['seek']['iteration']++;
?>
<?php if ($this->_var['format_0_23066500_1453275574'] == 'password'): ?>
...
<?php elseif ($this->_var['format_0_23066500_1453275574'] != 'attach' && $this->_var['format_0_23066500_1453275574'] != 'image' && $this->_var['format_0_23066500_1453275574'] != 'null' && $this->_var['format_0_23066500_1453275574'] != 'enabled' && $this->_var['format_0_23066500_1453275574'] != 'editor'): ?>
            <?php echo $this->_var['field']; ?>: {
<?php if ($this->_var['null'] [ $this->_var['field'] ] == 'NO'): ?>
                required: true,
<?php if ($this->_var['format_0_23066500_1453275574'] == 'catalog'): ?>
                min: 1<?php if ($this->_var['format_0_23066500_1453275574'] == 'text' || $this->_var['format_0_23066500_1453275574'] == 'textarea'): ?>,<?php endif; ?>

<?php elseif ($this->_var['format_0_23066500_1453275574'] == 'select-from-db' || $this->_var['format_0_23066500_1453275574'] == 'radio-from-db' || $this->_var['format_0_23066500_1453275574'] == 'checkbox-from-db'): ?>
                min: 1<?php if ($this->_var['format_0_23066500_1453275574'] == 'text' || $this->_var['format_0_23066500_1453275574'] == 'textarea'): ?>,<?php endif; ?>

<?php elseif (( $this->_var['format_0_23066500_1453275574'] == 'select-from-array' || $this->_var['format_0_23066500_1453275574'] == 'radio-from-array' || $this->_var['format_0_23066500_1453275574'] == 'checkbox-from-array' ) && $this->_var['integer'] [ $this->_var['field'] ]): ?>
                min: 1<?php if ($this->_var['format_0_23066500_1453275574'] == 'text' || $this->_var['format_0_23066500_1453275574'] == 'textarea'): ?>,<?php endif; ?>

<?php else: ?>
<?php endif; ?>
<?php endif; ?>
<?php if ($this->_var['format_0_23066500_1453275574'] == 'text' || $this->_var['format_0_23066500_1453275574'] == 'textarea'): ?>
                maxlength: <?php echo $this->_var['max_lengths'][$this->_var['field']]; ?>
...
<?php elseif ($this->_var['null'] [ $this->_var['field'] ] == 'NO'): ?>
            <?php echo $this->_var['field']; ?>: {
                required: true<?php if ($this->_var['format_0_23066500_1453275574'] == 'text' || $this->_var['format_0_23066500_1453275574'] == 'textarea'): ?>,<?php endif; ?>
...
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
        ...
        messages: {
<?php $_from = $this->_var['verify']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('field', 'format_0_23115200_1453275574');$this->_foreach['seek'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['seek']['total'] > 0):
    foreach ($_from AS $this->_var['field'] => $this->_var['format_0_23115200_1453275574']):
        $this->_foreach['seek']['iteration']++;
?>
<?php if ($this->_var['format_0_23115200_1453275574'] == 'password'): ?>
            <?php echo $this->_var['field']; ?>: {
<?php if ($this->_var['null'] [ $this->_var['field'] ] == 'NO'): ?>
...
<?php elseif ($this->_var['format_0_23115200_1453275574'] != 'attach' && $this->_var['format_0_23115200_1453275574'] != 'image' && $this->_var['format_0_23115200_1453275574'] != 'null' && $this->_var['format_0_23115200_1453275574'] != 'enabled' && $this->_var['format_0_23115200_1453275574'] != 'editor'): ?>
            <?php echo $this->_var['field']; ?>: {
<?php if ($this->_var['null'] [ $this->_var['field'] ] == 'NO'): ?>
                required: "<?php echo empty($this->_var['comments'][$this->_var['field']]) ? $this->_var['field'] : $this->_var['comments'][$this->_var['field']]; ?>不能为空。",
<?php if ($this->_var['format_0_23115200_1453275574'] == 'catalog'): ?>
                min: "请选择<?php echo empty($this->_var['comments'][$this->_var['field']]) ? $this->_var['field'] : $this->_var['comments'][$this->_var['field']]; ?>"<?php if ($this->_var['format_0_23115200_1453275574'] == 'text' || $this->_var['format_0_23115200_1453275574'] == 'textarea'): ?>,<?php endif; ?>

<?php elseif ($this->_var['format_0_23115200_1453275574'] == 'select-from-db' || $this->_var['format_0_23115200_1453275574'] == 'radio-from-db' || $this->_var['format_0_23115200_1453275574'] == 'checkbox-from-db'): ?>
                min: "请选择<?php echo empty($this->_var['comments'][$this->_var['field']]) ? $this->_var['field'] : $this->_var['comments'][$this->_var['field']]; ?>"<?php if ($this->_var['format_0_23115200_1453275574'] == 'text' || $this->_var['format_0_23115200_1453275574'] == 'textarea'): ?>,<?php endif; ?>

<?php elseif (( $this->_var['format_0_23115200_1453275574'] == 'select-from-array' || $this->_var['format_0_23115200_1453275574'] == 'radio-from-array' || $this->_var['format_0_23115200_1453275574'] == 'checkbox-from-array' ) && $this->_var['integer'] [ $this->_var['field'] ]): ?>
                min: "请选择<?php echo empty($this->_var['comments'][$this->_var['field']]) ? $this->_var['field'] : $this->_var['comments'][$this->_var['field']]; ?>"<?php if ($this->_var['format_0_23115200_1453275574'] == 'text' || $this->_var['format_0_23115200_1453275574'] == 'textarea'): ?>,<?php endif; ?>

<?php else: ?>
<?php endif; ?>
<?php endif; ?>
<?php if ($this->_var['format_0_23115200_1453275574'] == 'text' || $this->_var['format_0_23115200_1453275574'] == 'textarea'): ?>
                maxlength: "<?php echo empty($this->_var['comments'][$this->_var['field']]) ? $this->_var['field'] : $this->_var['comments'][$this->_var['field']]; ?>不能超过<?php echo $this->_var['max_lengths'][$this->_var['field']]; ?>个字符。"
<?php endif; ?>
            }<?php if (! ($this->_foreach['seek']['iteration'] == $this->_foreach['seek']['total'])): ?>,<?php endif; ?>
...
<?php elseif ($this->_var['null'] [ $this->_var['field'] ] == 'NO'): ?>
            <?php echo $this->_var['field']; ?>: {
                required: "<?php echo empty($this->_var['comments'][$this->_var['field']]) ? $this->_var['field'] : $this->_var['comments'][$this->_var['field']]; ?>不能为空。"<?php if ($this->_var['format_0_23115200_1453275574'] == 'text' || $this->_var['format_0_23115200_1453275574'] == 'textarea'): ?>,<?php endif; ?>
...
<?php if ($this->_var['position']): ?>
        groups: {
            position: "<?php $_from = $this->_var['position']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('field', 'format_0_23179500_1453275574');$this->_foreach['seek'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['seek']['total'] > 0):
    foreach ($_from AS $this->_var['field'] => $this->_var['format_0_23179500_1453275574']):
        $this->_foreach['seek']['iteration']++;
?><?php echo $this->_var['field']; ?><?php if (! ($this->_foreach['seek']['iteration'] == $this->_foreach['seek']['total'])): ?> <?php endif; ?><?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>"
        ...
        errorPlacement:function(error,element) {
            if (<?php $_from = $this->_var['position']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('field', 'format_0_23183600_1453275574');$this->_foreach['seek'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['seek']['total'] > 0):
    foreach ($_from AS $this->_var['field'] => $this->_var['format_0_23183600_1453275574']):
        $this->_foreach['seek']['iteration']++;
?>element.attr("name") == "<?php echo $this->_var['field']; ?>"<?php if (! ($this->_foreach['seek']['iteration'] == $this->_foreach['seek']['total'])): ?> || <?php endif; ?><?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>) {
                error.insertAfter("#<?php $_from = $this->_var['position']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('field', 'format_0_23187500_1453275574');$this->_foreach['seek'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['seek']['total'] > 0):
    foreach ($_from AS $this->_var['field'] => $this->_var['format_0_23187500_1453275574']):
        $this->_foreach['seek']['iteration']++;
