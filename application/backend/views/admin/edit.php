...
<?php endforeach;?>
          ...
          <div class="item"><label class="item-title mark" for="disabled">是否启用：</label><input type="checkbox" name="disabled" id="disabled" value="1"<?php if($admin->disabled == 1):?> checked="checked"<?php endif;?>/></div>
