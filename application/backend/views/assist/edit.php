...
<?php endforeach;?>
      ...
      <div id="subpanel">
        <form action="<?php echo base_url('assist/edit/'.$assist->id)?>" method="post" name="myform" id="myform">
          ...
          <div class="item"><label class="item-title mark" for="disabled">是否启用：</label><input type="checkbox" name="disabled" id="disabled" value="1"<?php if($assist->disabled == 1) echo ' checked="checked"';?>/></div>
